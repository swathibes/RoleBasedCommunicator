...
import com.rbc.testCase.BaseClass;
...
public class Reporting extends BaseClass implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setDocumentTitle("RoleBasedCommunicator Test Project"); // Tile of report
	...
	public void onTestFailure(ITestResult tr) {
		...
		try {
			BaseClass.captureScreen(tr.getName().toString());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
